...
public func getPremiumIntroController(context: AccountContext, presentationData: PresentationData, product: SKProduct) -> PremiumIntroController {
    ...
    controller.setState(.custom(icon: PremiumIntroControllerCustomIcon(light: UIImage(bundleImageName: "Nicegram/PremiumIntro"), dark: nil), title: title, subtitle: subtitle, text: text, buttonTitle: buttonTitle, footerText: nil), animated: true)
